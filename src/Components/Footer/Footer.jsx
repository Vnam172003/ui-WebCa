...
function Footer() {
  return (
    <div className="bg-mainColor-color_D9D9D9 ">
      <div className="container">
        <div className="grid grid-cols-12 mx-10 py-10 gap-7">
          <div className="col-span-4 text-mainColor-color_2D0000 ">
            ...
            <p>
              Shop cá cảnh Online chuyên cung cấp các dòng cá cảnh thủy sinh,
              tép cảnh, cá cảnh nhập khẩu
            </p>
          </div>
          ...
          <div className="col-span-3">
            ...
            <ul>
              <li>Giới thiệu</li>
              <li>Sản phẩm</li>
              <li>Một số thành tích của trại</li>
            </ul>
          </div>
